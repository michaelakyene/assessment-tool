...
const Login = ({ login }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="bg-white rounded-2xl shadow-2xl backdrop-blur-sm bg-opacity-95 transform hover:shadow-3xl transition-all duration-300">
          <form className="space-y-6 p-8" onSubmit={handleSubmit}>
                ...
                <div className="transform transition-all duration-300">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <FiUser className="h-5 w-5 text-gray-400 group-hover:text-indigo-500 transition-colors" />
                    </div>
                    <input
                      type="text"
                      name="name"
                      ...
                      required={!isLogin}
                      className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 hover:border-indigo-300"
                ...
                <div className="transform transition-all duration-300">
                  ...
                  <div className="relative">
                    <select
                      ...
                      value={formData.role}
                      onChange={handleChange}
                      className="block w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 hover:border-indigo-300 appearance-none bg-white"
                    >
                ...
                {formData.role === 'student' && (
                  <div className="transform transition-all duration-300 animate-fadeIn">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="block w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 hover:border-indigo-300"
                      placeholder="S123456"
                    />
                  </div>
                )}
            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FiMail className="h-5 w-5 text-gray-400 group-hover:text-indigo-500 transition-colors" />
                </div>
                <input
                  type="email"
                  name="email"
            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FiLock className="h-5 w-5 text-gray-400 group-hover:text-indigo-500 transition-colors" />
                </div>
                <input
                  ...
                  required
                  minLength={6}
                  className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 hover:border-indigo-300"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  {!loading && <FiCheckCircle className="h-5 w-5" />}
                </>
              )}
            </button>
          </form>
          ...
          <div className="px-8 py-6 bg-gradient-to-r from-gray-50 to-indigo-50 rounded-b-2xl border-t border-gray-100">
            <div className="text-center">
              <button
                ...
                className="text-indigo-600 hover:text-indigo-800 font-semibold text-sm transition-colors inline-flex items-center space-x-1 group"
              >
                <span>
                  {isLogin
