...
import { FiPlus, FiEye, FiTrash2, FiUsers, FiBarChart2, FiClock, FiEdit, FiCheckCircle, FiAlertCircle } from 'react-icons/fi'
  ...
  return (
    <div className="fixed top-20 right-4 z-50 animate-slideUp">
      <div className={`${
        ...
        {type === 'error' ? <FiAlertCircle className="w-5 h-5" /> : <FiCheckCircle className="w-5 h-5" />}
